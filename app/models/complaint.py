...
class Complaint(Base):
    ...
    processing_times: Mapped[str | None] = mapped_column(Text, nullable=True)
    processing_error: Mapped[str | None] = mapped_column(Text, nullable=True)
    speech_provider: Mapped[str | None] = mapped_column(String(50), nullable=True)
...
class ComplaintMedia(Base):
    ...
    analysis_metadata: Mapped[str | None] = mapped_column(Text, nullable=True)
